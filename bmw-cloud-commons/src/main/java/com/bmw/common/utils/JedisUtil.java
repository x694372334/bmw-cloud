...
// *
//* <p>Title: JedisUtil</p>
//* <p>Description: jedie的工具类，可操作5大基本类型</p>
//* @author lyl
//* @date 2018年5月14日
// */
//@Component
...
////		strings.setEx("test", 6000, "test");
////		return ResultUtils.getMethodData("成功");
////	}
//
//
//     /**缓存生存时间 */
...
//
//
//     private static final JedisUtil jedisUtil = new JedisUtil(jedisPool);
//
//
//    /**
//     * 获取JedisUtil实例
...
//        log.info("-----"+strings.get("nnn"));
//
//        Jedis jedis=JedisUtil.getInstance().getJedis();
//        for (int i = 0; i < 10; i++) {
//            jedis.set("test", "test");
//            log.info(i+"=="+jedis.get("test"));
//
//        }
