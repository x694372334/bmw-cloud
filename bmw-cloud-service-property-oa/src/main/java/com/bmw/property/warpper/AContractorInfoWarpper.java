 ...
 * @date 2018年4月19日
 */
public class AContractorInfoWarpper extends BaseControllerWarpper {

    public AContractorInfoWarpper(Object list) {
        super(list);
    }
    ...
    public void warpTheMap(JSONObject map) {
        ...
        Integer id = Integer.parseInt(map.get("cId").toString());
