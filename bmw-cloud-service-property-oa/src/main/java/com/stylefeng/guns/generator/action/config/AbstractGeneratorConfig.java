...
public abstract class AbstractGeneratorConfig {
    ...
    public void init() {
        ...
        packageConfig.setService(contextConfig.getProPackage() + ".bmw." + contextConfig.getModuleName() + ".service");
        packageConfig.setServiceImpl(contextConfig.getProPackage() + ".bmw." + contextConfig.getModuleName() + ".service.impl");
    ...
    public void doGunsGeneration() {
        ...
        GunsTemplateEngine.sebmwlConfig(sqlConfig);
