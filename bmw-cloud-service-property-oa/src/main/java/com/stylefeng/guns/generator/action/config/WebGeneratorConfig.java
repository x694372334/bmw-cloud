...
public class WebGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void config() {
        ...
        packageConfig.setEntity(genQo.getProjectPackage() + ".bmw." + genQo.getModuleName()+ ".model");
        packageConfig.setMapper(genQo.getProjectPackage() + ".bmw." + genQo.getModuleName() + ".dao");
        packageConfig.setXml(genQo.getProjectPackage() + ".bmw." + genQo.getModuleName() + ".dao.mapping");
        ...
        contextConfig.sebmwlSwitch(genQo.gebmwlSwitch());
    }
}
